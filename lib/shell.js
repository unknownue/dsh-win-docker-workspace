import { f as isWindowsDrivePath, h as normalizeWindowsPath, n as containerPathOf, o as resolveAnchorPath, r as getWorkspace, t as containerOwners } from "./win-docker-workspaces-BeycJyLC.js";
...
var DockerShellExecutor = class DockerShellExecutor extends ShellExecutor {
	...
	*/
	resolveContainer(spec, containerPath) {
		...
		if (fromStore !== void 0) return {
			container: fromStore.container,
			containerPath
		};
		...
		throw new Error(`docker-shell: container path carries no container; no session DSH_DOCKER_CONTAINER, workspace store entry, or container config is available${detail}`);
	}
	/**
